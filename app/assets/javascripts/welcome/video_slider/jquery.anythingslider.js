...
;(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.init = function(){
			...
			// Add "as-oldie" class to body for gallery_view purposes
		...
		base.buildNextBackButtons = function() {
			...
			// using tab to get to arrow links will show they have focus (outline is disabled in gallery_view)
	...
	$.anythingSlider.defaults = {
		// Appearance
		theme               : "default", // Theme name, add the gallery_view stylesheet manually
